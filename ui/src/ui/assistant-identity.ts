...
declare global {
  interface Window {
    __openlocalbot_ASSISTANT_NAME__?: string;
    __openlocalbot_ASSISTANT_AVATAR__?: string;
  }
}
...
export function resolveInjectedAssistantIdentity(): AssistantIdentity {
  ...
  return normalizeAssistantIdentity({
    name: window.__openlocalbot_ASSISTANT_NAME__,
    avatar: window.__openlocalbot_ASSISTANT_AVATAR__,
  });
}
