...
const shardOverride = Number.parseInt(process.env.openlocalbot_TEST_SHARDS ?? "", 10);
...
const windowsCiArgs = isWindowsCi
  ...
  : [];
const overrideWorkers = Number.parseInt(process.env.openlocalbot_TEST_WORKERS ?? "", 10);
