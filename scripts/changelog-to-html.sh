...
if [[ -z "$version_content" ]]; then
  echo "<h2>openlocalbot $VERSION</h2>"
  echo "<p>Latest openlocalbot update.</p>"
  echo "<p><a href=\"https://github.com/openlocalbot/openlocalbot/blob/main/CHANGELOG.md\">View full changelog</a></p>"
  exit 0
fi
