...
show_usage() {
    cat << EOF
clawlog - openlocalbot Logging Utility

USAGE:
    clawlog [OPTIONS]

DESCRIPTION:
    View openlocalbot logs with full details (bypasses Apple's privacy redaction).
    Requires sudo access configured for /usr/bin/log command.

LOG FLOW ARCHITECTURE:
    openlocalbot logs flow through the macOS unified log (subsystem: ai.openlocalbot).
