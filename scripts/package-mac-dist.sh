...
#
# Output:
# - dist/openlocalbot.app
# - dist/openlocalbot-<version>.zip
# - dist/openlocalbot-<version>.dmg
...
APP="$ROOT_DIR/dist/openlocalbot.app"
if [[ ! -d "$APP" ]]; then
...
ZIP="$ROOT_DIR/dist/openlocalbot-$VERSION.zip"
DMG="$ROOT_DIR/dist/openlocalbot-$VERSION.dmg"
NOTARY_ZIP="$ROOT_DIR/dist/openlocalbot-$VERSION.notary.zip"
