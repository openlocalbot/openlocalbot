...
import {
  ...
  type openlocalbotPackageManifest,
...
function deriveIdHint(params: {
  ...
  // package is scoped (example: @openlocalbot/voice-call -> voice-call).
...
export function discoveropenlocalbotPlugins(params: {
  workspaceDir?: string;
  extraPaths?: string[];
  ...
  if (workspaceDir) {
    ...
    const workspaceExtDirs = [path.join(workspaceRoot, ".openlocalbot", "extensions")];
