...
describe("Agent-specific tool filtering", () => {
    ...
    const cfg: openlocalbotConfig = {
      ...
      agents: {
        list: [
          {
            id: "restricted",
            workspace: "~/openlocalbot-restricted",
            tools: {
  ...
  it("should allow different tool policies for different agents", () => {
    ...
    const mainTools = createopenlocalbotCodingTools({
      config: cfg,
      sessionKey: "agent:main:main",
    ...
    const familyTools = createopenlocalbotCodingTools({
      config: cfg,
  ...
  it("should apply group tool policy overrides (group-specific beats wildcard)", () => {
    ...
    const trustedTools = createopenlocalbotCodingTools({
      config: cfg,
  ...
  it("should apply per-sender tool policies for group tools", () => {
    ...
    const aliceTools = createopenlocalbotCodingTools({
      config: cfg,
    ...
    const bobTools = createopenlocalbotCodingTools({
      config: cfg,
      sessionKey: "agent:main:whatsapp:group:family",
      senderId: "bob",
  ...
  it("should not let default sender policy override group tools", () => {
    ...
    const adminTools = createopenlocalbotCodingTools({
      config: cfg,
