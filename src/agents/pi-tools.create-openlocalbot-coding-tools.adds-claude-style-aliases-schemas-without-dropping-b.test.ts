...
describe("createopenlocalbotCodingTools", () => {
  ...
  it("gates apply_patch behind tools.exec.applyPatch for OpenAI models", () => {
    ...
    const openAiTools = createopenlocalbotCodingTools({
      config,
    ...
    const anthropicTools = createopenlocalbotCodingTools({
      config,
  ...
  it("respects apply_patch allowModels", () => {
    ...
    const allowed = createopenlocalbotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5.2",
    });
    ...
    const denied = createopenlocalbotCodingTools({
      config,
      modelProvider: "openai",
      modelId: "gpt-5-mini",
    });
