...
export const DEFAULT_SANDBOX_WORKSPACE_ROOT = path.join(os.homedir(), ".openlocalbot", "sandboxes");

export const DEFAULT_SANDBOX_IMAGE = "openlocalbot-sandbox:bookworm-slim";
export const DEFAULT_SANDBOX_CONTAINER_PREFIX = "openlocalbot-sbx-";
...
export const DEFAULT_SANDBOX_BROWSER_IMAGE = "openlocalbot-sandbox-browser:bookworm-slim";
export const DEFAULT_SANDBOX_COMMON_IMAGE = "openlocalbot-sandbox-common:bookworm-slim";

export const DEFAULT_SANDBOX_BROWSER_PREFIX = "openlocalbot-sbx-browser-";
...
const resolvedSandboxStateDir = STATE_DIR ?? path.join(os.homedir(), ".openlocalbot");
