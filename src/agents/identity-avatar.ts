...
function resolveAvatarSource(cfg: OpenLocalBotConfig, agentId: string): string | null {
...
export function resolveAgentAvatar(cfg: OpenLocalBotConfig, agentId: string): AgentAvatarResolution {
