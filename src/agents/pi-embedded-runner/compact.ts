...
import { resolveopenlocalbotDocsPath } from "../docs-path.js";
...
export async function compactEmbeddedPiSessionDirect(
  ...
  const agentDir = params.agentDir ?? resolveOpenLocalBotAgentDir();
  await ensureopenlocalbotModelsJson(params.config, agentDir);
  ...
  try {
    ...
    const toolsRaw = createopenlocalbotCodingTools({
      exec: {
    ...
    const docsPath = await resolveopenlocalbotDocsPath({
      workspaceDir: effectiveWorkspace,
