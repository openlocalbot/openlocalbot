...
function resolveWatchPaths(workspaceDir: string, config?: OpenLocalBotConfig): string[] {
  const paths: string[] = [];
...
export function ensureSkillsWatcher(params: { workspaceDir: string; config?: OpenLocalBotConfig }) {
