...
export const DEFAULT_LOG_DIR = "/tmp/openlocalbot";
export const DEFAULT_LOG_FILE = path.join(DEFAULT_LOG_DIR, "openlocalbot.log"); // legacy single-file path

const LOG_PREFIX = "openlocalbot";
