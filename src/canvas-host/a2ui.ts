...
export const A2UI_PATH = "/__openlocalbot__/a2ui";

export const CANVAS_HOST_PATH = "/__openlocalbot__/canvas";

export const CANVAS_WS_PATH = "/__openlocalbot__/ws";
...
(() => {
  ...
  // Works on:
  // - iOS: window.webkit.messageHandlers.openlocalbotCanvasA2UIAction.postMessage(...)
  // - Android: window.openlocalbotCanvasA2UIAction.postMessage(...)
  const handlerNames = ["openlocalbotCanvasA2UIAction"];
  ...
  globalThis.openlocalbot = globalThis.openlocalbot ?? {};
  globalThis.openlocalbot.postMessage = postToNode;
  globalThis.openlocalbot.sendUserAction = sendUserAction;
  globalThis.openlocalbotPostMessage = postToNode;
  globalThis.openlocalbotSendUserAction = sendUserAction;
