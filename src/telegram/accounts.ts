...
const debugAccounts = (...args: unknown[]) => {
  if (isTruthyEnvValue(process.env.openlocalbot_DEBUG_TELEGRAM_ACCOUNTS)) {
...
export function listTelegramAccountIds(cfg: openlocalbotConfig): string[] {
...
export function resolveDefaultTelegramAccountId(cfg: openlocalbotConfig): string {
...
function mergeTelegramAccountConfig(cfg: openlocalbotConfig, accountId: string): TelegramAccountConfig {
...
export function listEnabledTelegramAccounts(cfg: openlocalbotConfig): ResolvedTelegramAccount[] {
