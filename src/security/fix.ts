...
function setGroupPolicyAllowlist(params: {
  ...
  const section = params.cfg.channels[params.channel as keyof openlocalbotConfig["channels"]] as
...
function applyConfigFixes(params: { cfg: openlocalbotConfig; env: NodeJS.ProcessEnv }): {
  cfg: openlocalbotConfig;
  changes: string[];
  policyFlips: Set<string>;
} {
