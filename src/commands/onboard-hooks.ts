...
export async function setupInternalHooks(
  ...
  await prompter.note(
    [
      ...
      "",
      "Learn more: https://docs.openlocalbot.ai/hooks",
    ].join("\n"),
    "Hooks",
  );
  ...
  await prompter.note(
    [
      ...
      `  ${formatCliCommand("openlocalbot hooks list")}`,
      `  ${formatCliCommand("openlocalbot hooks enable <name>")}`,
      `  ${formatCliCommand("openlocalbot hooks disable <name>")}`,
    ].join("\n"),
    "Hooks Configured",
  );
