...
function shouldShowProviderEntry(entry: ProviderAccountStatus, cfg: OpenLocalBotConfig): boolean {
...
export function summarizeBindings(cfg: OpenLocalBotConfig, bindings: AgentBinding[]): string[] {
