...
export function summarizeExistingConfig(config: openlocalbotConfig): string {
  const rows: string[] = [];
...
export function formatControlUiSshHint(params: {
  ...
  return [
    ...
    authedUrl,
    "Docs:",
    "https://docs.openlocalbot.ai/gateway/remote",
    "https://docs.openlocalbot.ai/web/control-ui",
  ]
    .filter(Boolean)
    .join("\n");
}
