...
export type openlocalbotHookMetadata = {
  always?: boolean;
  hookKey?: string;
  emoji?: string;
  homepage?: string;
...
export type Hook = {
  name: string;
  description: string;
  source: "openlocalbot-bundled" | "openlocalbot-managed" | "openlocalbot-workspace" | "openlocalbot-plugin";
  pluginId?: string;
...
export type HookEntry = {
  ...
  metadata?: openlocalbotHookMetadata;
