...
import type { openlocalbotPluginApi } from "../plugins/types.js";
...
function resolveHookDir(api: openlocalbotPluginApi, dir: string): string {
...
function normalizePluginHookEntry(api: openlocalbotPluginApi, entry: HookEntry): HookEntry {
  return {
    ...entry,
    hook: {
      ...entry.hook,
