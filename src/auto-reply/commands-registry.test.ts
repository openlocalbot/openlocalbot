...
describe("commands registry", () => {
  ...
  it("normalizes telegram-style command mentions for the current bot", () => {
    expect(normalizeCommandBody("/help@openlocalbot", { botUsername: "openlocalbot" })).toBe("/help");
    expect(
      normalizeCommandBody("/help@openlocalbot args", {
        botUsername: "openlocalbot",
      }),
    ).toBe("/help args");
    expect(
      normalizeCommandBody("/help@openlocalbot: args", {
  ...
  it("keeps telegram-style command mentions for other bots", () => {
    expect(normalizeCommandBody("/help@otherbot", { botUsername: "openlocalbot" })).toBe(
      "/help@otherbot",
    );
  });
