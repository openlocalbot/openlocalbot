...
export function listBindings(cfg: OpenLocalBotConfig): AgentBinding[] {
  return Array.isArray(cfg.bindings) ? cfg.bindings : [];
}

export function listBoundAccountIds(cfg: OpenLocalBotConfig, channelId: string): string[] {
...
export function buildChannelAccountBindings(cfg: OpenLocalBotConfig) {
