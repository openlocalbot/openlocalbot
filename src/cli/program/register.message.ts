...
${formatHelpExamples([
  ['openlocalbot message send --target +15555550123 --message "Hi"', "Send a text message."],
  [
    'openlocalbot message send --target +15555550123 --message "Hi" --media photo.jpg',
  ...
  [
    'openlocalbot message react --channel discord --target 123 --message-id 456 --emoji "✅"',
    "React to a message.",
  ],
])}

${theme.muted("Docs:")} ${formatDocsLink("/cli/message", "docs.openlocalbot.ai/cli/message")}`,
    )
    .action(() => {
