...
export function registerBrowserManageCommands(
  ...
  browser
    ...
    .action(async (_opts, cmd) => {
      ...
      await runBrowserCommand(async () => {
        ...
        defaultRuntime.log(
          [
            `profile: ${status.profile ?? "openlocalbot"}`,
  ...
  browser
    ...
    .action(async (_opts, cmd) => {
      ...
      await runBrowserCommand(async () => {
        ...
        const name = status.profile ?? "openlocalbot";
  ...
  browser
    ...
    .option("--driver <driver>", "Profile driver (openlocalbot|extension). Default: openlocalbot")
    .action(
