...
export type ChannelAgentToolFactory = (params: { cfg?: openlocalbotConfig }) => ChannelAgentTool[];
...
export type ChannelAgentPromptAdapter = {
  messageToolHints?: (params: { cfg: openlocalbotConfig; accountId?: string | null }) => string[];
};
...
export type ChannelMessageActionAdapter = {
  listActions?: (params: { cfg: openlocalbotConfig }) => ChannelMessageActionName[];
  supportsAction?: (params: { action: ChannelMessageActionName }) => boolean;
  supportsButtons?: (params: { cfg: openlocalbotConfig }) => boolean;
  supportsCards?: (params: { cfg: openlocalbotConfig }) => boolean;
