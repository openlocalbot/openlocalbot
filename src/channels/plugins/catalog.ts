...
import type { openlocalbotPackageManifest } from "../../plugins/manifest.js";
import type { PluginOrigin } from "../../plugins/types.js";
import type { ChannelMeta } from "./types.js";
import { MANIFEST_KEY } from "../../compat/legacy-names.js";
import { discoveropenlocalbotPlugins } from "../../plugins/discovery.js";
...
type ExternalCatalogEntry = {
  ...
  version?: string;
  description?: string;
} & Partial<Record<ManifestKey, openlocalbotPackageManifest>>;
...
const ENV_CATALOG_PATHS = ["openlocalbot_PLUGIN_CATALOG_PATHS", "openlocalbot_MPM_CATALOG_PATHS"];
...
function toChannelMeta(params: {
  channel: NonNullable<openlocalbotPackageManifest["channel"]>;
  id: string;
}): ChannelMeta | null {
...
function resolveInstallInfo(params: {
  manifest: openlocalbotPackageManifest;
  packageName?: string;
  packageDir?: string;
  workspaceDir?: string;
...
function buildCatalogEntry(candidate: {
  ...
  packageDir?: string;
  workspaceDir?: string;
  packageManifest?: openlocalbotPackageManifest;
...
export function listChannelPluginCatalogEntries(
  ...
  const discovery = discoveropenlocalbotPlugins({ workspaceDir: options.workspaceDir });
