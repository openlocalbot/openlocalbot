...
public enum openlocalbotCanvasA2UICommand: String, Codable, Sendable {
...
public struct openlocalbotCanvasA2UIPushParams: Codable, Sendable, Equatable {
...
public struct openlocalbotCanvasA2UIPushJSONLParams: Codable, Sendable, Equatable {
