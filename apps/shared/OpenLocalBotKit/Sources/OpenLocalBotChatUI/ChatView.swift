...
@MainActor
public struct openlocalbotChatView: View {
    public enum Style {
        case standard
        case onboarding
    }

    @State private var viewModel: openlocalbotChatViewModel
    ...
    public init(
        viewModel: openlocalbotChatViewModel,
    ...
    public var body: some View {
        ZStack {
            if self.style == .standard {
                openlocalbotChatTheme.background
                    .ignoresSafeArea()
            }
    ...
    private var visibleMessages: [openlocalbotChatMessage] {
        let base: [openlocalbotChatMessage]
    ...
    private func mergeToolResults(in messages: [openlocalbotChatMessage]) -> [openlocalbotChatMessage] {
        ...
        for message in messages {
            ...
            let merged = openlocalbotChatMessage(
                id: last.id,
                role: last.role,
                content: content,
    ...
    private func isToolResultMessage(_ message: openlocalbotChatMessage) -> Bool {
        let role = message.role.lowercased()
        return role == "toolresult" || role == "tool_result"
    }

    private func toolCallIds(in message: openlocalbotChatMessage) -> Set<String> {
        var ids = Set<String>()
    ...
    private func toolResultText(from message: openlocalbotChatMessage) -> String {
