...
public typealias openlocalbotPlatformImage = NSImage
#elseif canImport(UIKit)
import UIKit

public typealias openlocalbotPlatformImage = UIImage
#endif

public struct openlocalbotChatUsageCost: Codable, Hashable, Sendable {
...
public struct openlocalbotChatUsage: Codable, Hashable, Sendable {
    public let input: Int?
    public let output: Int?
    public let cacheRead: Int?
    public let cacheWrite: Int?
    public let cost: openlocalbotChatUsageCost?
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.cost = try container.decodeIfPresent(openlocalbotChatUsageCost.self, forKey: .cost)
        self.total =
...
public struct openlocalbotChatMessageContent: Codable, Hashable, Sendable {
...
public struct openlocalbotChatMessage: Codable, Identifiable, Sendable {
    public var id: UUID = .init()
    public let role: String
    public let content: [openlocalbotChatMessageContent]
    public let timestamp: Double?
    public let toolCallId: String?
    public let toolName: String?
    public let usage: openlocalbotChatUsage?
    ...
    public init(
        id: UUID = .init(),
        role: String,
        content: [openlocalbotChatMessageContent],
        timestamp: Double?,
        toolCallId: String? = nil,
        toolName: String? = nil,
        usage: openlocalbotChatUsage? = nil,
    ...
    public init(from decoder: Decoder) throws {
        ...
        self.usage = try container.decodeIfPresent(openlocalbotChatUsage.self, forKey: .usage)
        self.stopReason = try container.decodeIfPresent(String.self, forKey: .stopReason)

        if let decoded = try? container.decode([openlocalbotChatMessageContent].self, forKey: .content) {
...
public struct openlocalbotChatHistoryPayload: Codable, Sendable {
...
public struct openlocalbotSessionPreviewItem: Codable, Hashable, Sendable {
    public let role: String
    public let text: String
}

public struct openlocalbotSessionPreviewEntry: Codable, Sendable {
    public let key: String
    public let status: String
    public let items: [openlocalbotSessionPreviewItem]
}

public struct openlocalbotSessionsPreviewPayload: Codable, Sendable {
    public let ts: Int
    public let previews: [openlocalbotSessionPreviewEntry]

    public init(ts: Int, previews: [openlocalbotSessionPreviewEntry]) {
        self.ts = ts
        self.previews = previews
    }
}

public struct openlocalbotChatSendResponse: Codable, Sendable {
    public let runId: String
    public let status: String
}

public struct openlocalbotChatEventPayload: Codable, Sendable {
    public let runId: String?
    public let sessionKey: String?
...
public struct openlocalbotAgentEventPayload: Codable, Sendable, Identifiable {
...
public struct openlocalbotChatPendingToolCall: Identifiable, Hashable, Sendable {
...
public struct openlocalbotGatewayHealthOK: Codable, Sendable {
    public let ok: Bool?
}

public struct openlocalbotPendingAttachment: Identifiable {
    public let id = UUID()
    public let url: URL?
    ...
    public let mimeType: String
    public let type: String
    public let preview: openlocalbotPlatformImage?
    ...
    public init(
        ...
        mimeType: String,
        type: String = "file",
        preview: openlocalbotPlatformImage?)
    {
        self.url = url
        self.data = data
        self.fileName = fileName
...
public struct openlocalbotChatAttachmentPayload: Codable, Sendable, Hashable {
    public let type: String
    public let mimeType: String
    public let fileName: String
