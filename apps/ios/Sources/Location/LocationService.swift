...
final class LocationService: NSObject, CLLocationManagerDelegate {
    ...
    func ensureAuthorization(mode: openlocalbotLocationMode) async -> CLAuthorizationStatus {
    ...
    func currentLocation(
        params: openlocalbotLocationGetParams,
    ...
    private static func accuracyValue(_ accuracy: openlocalbotLocationAccuracy) -> CLLocationAccuracy {
        switch accuracy {
        case .coarse:
