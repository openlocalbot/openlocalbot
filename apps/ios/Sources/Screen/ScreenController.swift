...
final class ScreenController {
    ...
    /// Callback invoked when an openlocalbot:// deep link is tapped in the canvas
    ...
    private static func bundledResourceURL(
        ...
        -> URL?
    {
        let bundle = openlocalbotKitResources.bundle
...
/// Handles navigation policy to intercept openlocalbot:// deep links from canvas
@MainActor
private final class ScreenNavigationDelegate: NSObject, WKNavigationDelegate {
        ...
        decisionHandler: @escaping @MainActor @Sendable (WKNavigationActionPolicy) -> Void)
    {
        ...
        // Intercept openlocalbot:// deep links.
        if url.scheme?.lowercased() == "openlocalbot" {
