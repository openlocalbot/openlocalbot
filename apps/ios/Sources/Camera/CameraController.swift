...
actor CameraController {
    ...
    func snap(params: openlocalbotCameraSnapParams) async throws -> (
        format: String,
        base64: String,
        width: Int,
        height: Int)
    ...
    func clip(params: openlocalbotCameraClipParams) async throws -> (
        format: String,
        base64: String,
        durationMs: Int,
        hasAudio: Bool)
    {
        ...
        let movURL = FileManager().temporaryDirectory
            .appendingPathComponent("openlocalbot-camera-\(UUID().uuidString).mov")
        let mp4URL = FileManager().temporaryDirectory
            .appendingPathComponent("openlocalbot-camera-\(UUID().uuidString).mp4")
    ...
    private nonisolated static func pickCamera(
        facing: openlocalbotCameraFacing,
