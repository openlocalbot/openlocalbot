## openlocalbot Node (Android) (internal)

Modern Android node app: connects to the **Gateway WebSocket** (`_openlocalbot-gw._tcp`) and exposes **Canvas + Chat + Camera**.
...
```bash
pnpm openlocalbot gateway --port 18789 --verbose
```
