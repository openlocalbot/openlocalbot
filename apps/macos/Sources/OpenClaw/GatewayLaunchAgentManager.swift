...
enum GatewayLaunchAgentManager {
    private static let logger = Logger(subsystem: "ai.openlocalbot", category: "gateway.launchd")
    private static let disableLaunchAgentMarker = ".openlocalbot/disable-launchagent"
...
extension GatewayLaunchAgentManager {
    ...
    {
        let command = CommandResolver.openlocalbotCommand(
            subcommand: "gateway",
