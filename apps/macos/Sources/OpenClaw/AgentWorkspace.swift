...
enum AgentWorkspace {
    private static let logger = Logger(subsystem: "ai.openlocalbot", category: "workspace")
    ...
    static func resolveWorkspaceURL(from userInput: String?) -> URL {
        ...
        if trimmed.isEmpty { return OpenLocalBotConfigFile.defaultWorkspaceURL() }
    ...
    static func defaultTemplate() -> String {
        let fallback = """
        # AGENTS.md - openlocalbot Workspace
    ...
    static func defaultBootstrapTemplate() -> String {
        ...
        3) ~/.openlocalbot/openlocalbot.json
