...
/// Menu contents for the openlocalbot menu bar extra.
struct MenuContent: View {
    ...
    var body: some View {
        VStack(alignment: .leading, spacing: 8) {
            ...
            self.debugMenu
            Button("About openlocalbot") { self.open(tab: .about) }
    ...
    private var connectionLabel: String {
        ...
        case .unconfigured:
            "openlocalbot Not Configured"
        case .remote:
            "Remote openlocalbot Active"
        case .local:
            "openlocalbot Active"
        }
    }
    ...
    private func open(tab: SettingsTab) {
        ...
        DispatchQueue.main.async {
            NotificationCenter.default.post(name: .openlocalbotSelectSettingsTab, object: tab)
        }
    }
