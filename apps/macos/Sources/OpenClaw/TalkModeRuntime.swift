...
actor TalkModeRuntime {
    ...
    private let logger = Logger(subsystem: "ai.openlocalbot", category: "talk.runtime")
    private let ttsLogger = Logger(subsystem: "ai.openlocalbot", category: "talk.tts")
    ...
    private func latestAssistantText(sessionKey: String, since: Double? = nil) async -> String? {
        do {
            ...
            let decoded: [openlocalbotChatMessage] = messages.compactMap { item in
