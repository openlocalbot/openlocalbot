...
private struct EventRow: View {
    ...
    private func prettyJSON(_ dict: [String: openlocalbotProtocol.AnyCodable]) -> String? {
...
struct AgentEventsWindow_Previews: PreviewProvider {
    static var previews: some View {
        let sample = ControlAgentEvent(
            ...
            data: [
                "phase": openlocalbotProtocol.AnyCodable("start"),
                "name": openlocalbotProtocol.AnyCodable("bash"),
            ],
            summary: nil)
