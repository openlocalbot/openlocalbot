...
struct AboutSettings: View {
    ...
    var body: some View {
        VStack(spacing: 8) {
            ...
            Button {
                if let url = URL(string: "https://github.com/openlocalbot/openlocalbot") {
            ...
            VStack(alignment: .center, spacing: 6) {
                AboutLinkRow(
                    ...
                    title: "GitHub",
                    url: "https://github.com/openlocalbot/openlocalbot")
                AboutLinkRow(icon: "globe", title: "Website", url: "https://openlocalbot.ai")
    ...
    private var buildTimestamp: String? {
        guard
            let raw =
                (Bundle.main.object(forInfoDictionaryKey: "openlocalbotBuildTimestamp") as? String) ??
                (Bundle.main.object(forInfoDictionaryKey: "openlocalbotBuildTimestamp") as? String)
        else { return nil }
    ...
    private var gitCommit: String {
        (Bundle.main.object(forInfoDictionaryKey: "openlocalbotGitCommit") as? String) ??
            (Bundle.main.object(forInfoDictionaryKey: "openlocalbotGitCommit") as? String) ??
            "unknown"
    }
