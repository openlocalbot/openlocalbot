...
enum ExecApprovalsStore {
    private static let logger = Logger(subsystem: "ai.openlocalbot", category: "exec-approvals")
    ...
    static func fileURL() -> URL {
        openlocalbotPaths.stateDirURL.appendingPathComponent("exec-approvals.json")
    }

    static func socketPath() -> String {
        openlocalbotPaths.stateDirURL.appendingPathComponent("exec-approvals.sock").path
    }
