...
final class VoiceWakeOverlayController {
    ...
    let logger = Logger(subsystem: "ai.openlocalbot", category: "voicewake.overlay")
    let enableUI: Bool

    /// Keep the voice wake overlay above any other openlocalbot windows, but below the system’s pop-up menus.
