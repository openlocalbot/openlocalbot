...
struct SettingsRootView: View {
    ...
    var body: some View {
        ...
        .onReceive(NotificationCenter.default.publisher(for: .openlocalbotSelectSettingsTab)) { note in
    ...
    private var nixManagedBanner: some View {
        ...
        let configPath = self.snapshotPaths.configPath ?? openlocalbotPaths.configURL.path
        let stateDir = self.snapshotPaths.stateDir ?? openlocalbotPaths.stateDirURL.path
...
extension Notification.Name {
    static let openlocalbotSelectSettingsTab = Notification.Name("openlocalbotSelectSettingsTab")
}
