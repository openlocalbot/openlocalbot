...
read_when:
  - You are building a openlocalbot plugin
  - You need to ship a plugin config schema or debug plugin validation errors
title: "Plugin Manifest"
---

# Plugin manifest (openlocalbot.plugin.json)

Every plugin **must** ship a `openlocalbot.plugin.json` file in the **plugin root**.
openlocalbot uses this manifest to validate configuration **without executing plugin
