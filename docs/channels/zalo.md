...
- Install via CLI: `openlocalbot plugins install @openlocalbot/zalo`
...
1. Install the Zalo plugin:
   - From a source checkout: `openlocalbot plugins install ./extensions/zalo`
   - From npm (if published): `openlocalbot plugins install @openlocalbot/zalo`
...
- Approve via:
  - `openlocalbot pairing list zalo`
  - `openlocalbot pairing approve zalo <CODE>`
...
- Example: `openlocalbot message send --channel zalo --target 123456789 --message "hi"`.

## Troubleshooting

**Bot doesn't respond:**

- Check that the token is valid: `openlocalbot channels status --probe`
- Verify the sender is approved (pairing or allowFrom)
- Check gateway logs: `openlocalbot logs --follow`
