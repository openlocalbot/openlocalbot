---
summary: "Use Xiaomi MiMo (mimo-v2-flash) with openlocalbot"
read_when:
  - You want Xiaomi MiMo models in openlocalbot
...
the [Xiaomi MiMo console](https://platform.xiaomimimo.com/#/console/api-keys). openlocalbot uses
...
```bash
openlocalbot onboard --auth-choice xiaomi-api-key
# or non-interactive
openlocalbot onboard --auth-choice xiaomi-api-key --xiaomi-api-key "$XIAOMI_API_KEY"
```
