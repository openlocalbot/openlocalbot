---
summary: "Use Qwen OAuth (free tier) in openlocalbot"
read_when:
  - You want to use Qwen with openlocalbot
...
```bash
openlocalbot models set qwen-portal/coder-model
```

## Reuse Qwen Code CLI login

If you already logged in with the Qwen Code CLI, openlocalbot will sync credentials
