---
summary: "Model providers (LLMs) supported by openlocalbot"
read_when:
...
openlocalbot can use many LLM providers. Pick one, authenticate, then set the default
...
1. Authenticate with the provider (usually via `openlocalbot onboard`).
