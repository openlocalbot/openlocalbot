...
You can point openlocalbot at the proxy as a custom OpenAI-compatible endpoint:
...
- This is a **community tool**, not officially supported by Anthropic or openlocalbot
...
- [Anthropic provider](/providers/anthropic) - Native openlocalbot integration with Claude setup-token or API keys
