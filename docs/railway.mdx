...
Deploy openlocalbot on Railway with a one-click template and finish setup in your browser.
...
- `https://<your-railway-domain>/openlocalbot` — Control UI
...
- `openlocalbot_STATE_DIR=/data/.openlocalbot` (recommended)
- `openlocalbot_WORKSPACE_DIR=/data/workspace` (recommended)
- `openlocalbot_GATEWAY_TOKEN` (recommended; treat as an admin secret)
...
This exports your openlocalbot state + workspace so you can migrate to another host without losing config or memory.
