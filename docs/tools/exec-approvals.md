...
- **gateway host** → `openlocalbot` process on the gateway machine
...
`~/.openlocalbot/exec-approvals.json` directly.

CLI: `openlocalbot approvals` supports gateway or node editing (see [Approvals CLI](/cli/approvals)).
