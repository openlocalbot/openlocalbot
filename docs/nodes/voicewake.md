...
openlocalbot treats **wake words as a single global list** owned by the **Gateway**.
...
- `~/.openlocalbot/settings/voicewake.json`

Shape:

```json
{ "triggers": ["openlocalbot", "claude", "computer"], "updatedAtMs": 1730000000000 }
```
