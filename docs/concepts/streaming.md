...
openlocalbot has two separate “streaming” layers:
...
When block streaming is enabled, openlocalbot can **merge consecutive block chunks**
...
When draft streaming is active, openlocalbot disables block streaming for that reply to avoid double-streaming.
