...
This page ties together how openlocalbot handles inbound messages, sessions, queueing,
...
Channels can redeliver the same message after reconnects. openlocalbot keeps a
...
openlocalbot separates the **prompt body** from the **command body**:
...
openlocalbot can expose or hide model reasoning:
