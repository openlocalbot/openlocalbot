...
export function listGoogleChatAccountIds(cfg: OpenLocalBotConfig): string[] {
...
export function resolveDefaultGoogleChatAccountId(cfg: OpenLocalBotConfig): string {
...
export function listEnabledGoogleChatAccounts(cfg: OpenLocalBotConfig): ResolvedGoogleChatAccount[] {
