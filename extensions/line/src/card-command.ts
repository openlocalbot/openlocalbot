import type { LineChannelData, openlocalbotPluginApi, ReplyPayload } from "openlocalbot/plugin-sdk";
import {
  createActionCard,
  createImageCard,
  createInfoCard,
...
export function registerLineCardCommand(api: openlocalbotPluginApi): void {
  api.registerCommand({
    name: "card",
