...
export function listZalouserAccountIds(cfg: OpenLocalBotConfig): string[] {
...
export function resolveDefaultZalouserAccountId(cfg: OpenLocalBotConfig): string {
...
function mergeZalouserAccountConfig(cfg: OpenLocalBotConfig, accountId: string): ZalouserAccountConfig {
