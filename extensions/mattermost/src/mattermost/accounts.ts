...
export function listMattermostAccountIds(cfg: openlocalbotConfig): string[] {
...
export function resolveDefaultMattermostAccountId(cfg: openlocalbotConfig): string {
...
export function listEnabledMattermostAccounts(cfg: openlocalbotConfig): ResolvedMattermostAccount[] {
