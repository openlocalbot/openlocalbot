...
- Version alignment with core openlocalbot release numbers.
...
- First public release of the @openlocalbot/voice-call plugin.
...
- CLI: `openlocalbot voicecall` commands (call/start/continue/speak/end/status/tail/expose).
