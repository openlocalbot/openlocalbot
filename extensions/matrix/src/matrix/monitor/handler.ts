...
export type MatrixMonitorHandlerParams = {
  ...
  core: {
    ...
    channel: (typeof import("openlocalbot/plugin-sdk"))["channel"];
    system: {
      enqueueSystemEvent: (
        text: string,
  ...
  mentionRegexes: ReturnType<
    (typeof import("openlocalbot/plugin-sdk"))["channel"]["mentions"]["buildMentionRegexes"]
  >;
              ...
              if (created) {
                ...
                try {
                  await sendMessageMatrix(
                    `room:${roomId}`,
                    [
                      "openlocalbot: access not configured.",
                      "",
                      `Pairing code: ${code}`,
                      "",
