...
Nostr DM channel plugin for openlocalbot using NIP-04 encrypted direct messages.

## Overview

This extension adds Nostr as a messaging channel to openlocalbot. It enables your bot to:
...
# Configure openlocalbot to use local relay
